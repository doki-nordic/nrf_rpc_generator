...
class Param {
	...
	generateCliSendFunc(blocks) {
		...
		this._generateBlock(blocks, CodeBlocks.ENCODE_PARAMS, 'sendFuncEnc');
	...
	generateHostRecvFunc(blocks) {
		...
		this._generateBlock(blocks, CodeBlocks.DECODE_PARAMS, 'recvFuncDec');
		...
		this._generateBlock(blocks, CodeBlocks.OUTPUT_ALLOC, 'recvFuncCalc');
...
class GenFunc {
	...
	generateHostRecvFunc() {
		...
		if (CodeBlocks.DECODE_PARAMS in blocks && blocks[CodeBlocks.DECODE_PARAMS].length > 0) {
...
exports.generateCliRspFunc = generateCliRspFunc;
exports.generateCliResStruct = generateCliResStruct;
